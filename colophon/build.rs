...
fn main() {
    ...
    // GSETTINGS_SCHEMA_DIR at the top-level data/, which also feeds the
    // meson install). Non-fatal: without it the app falls back to defaults
    // via the settings() Option accessor.
